...
#     '가격': [500, 550, 600, 650, 700, 750, 800, 850, 900, 950]
# }


df = pd.DataFrame(data)

def visualize_trend(df, region):
    region_data = df[df['주소'] == region]
    
    plt.figure(figsize=(10, 6))
    plt.plot(region_data.index, region_data['가격'], marker='o', linestyle='-')
